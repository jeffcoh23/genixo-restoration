...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index lists pending login requests with resolution flags" do
    pending = LoginRequest.create!(email: "new@acme.com", first_name: "New", last_name: "Person", company_name: "Greystar", phone: "5125550100")
    existing = LoginRequest.create!(email: "mgr@genixo.com", first_name: "Already", last_name: "Here", company_name: "Greystar", phone: "5125550100")
    invited = LoginRequest.create!(email: "invited@acme.com", first_name: "In", last_name: "Vited", company_name: "Greystar", phone: "5125550100")
  ...
  test "index hides approved requests once an invitation exists" do
    approved = LoginRequest.create!(email: "done@acme.com", first_name: "Done", last_name: "Deal", company_name: "Greystar", phone: "5125550100")
    approved.approve!(@manager)
    stranded = LoginRequest.create!(email: "stranded@acme.com", first_name: "Str", last_name: "Anded", company_name: "Greystar", phone: "5125550100")
  ...
  test "index excludes rejected requests" do
    rejected = LoginRequest.create!(email: "no@acme.com", first_name: "No", last_name: "Thanks", company_name: "Greystar", phone: "5125550100")
