  ...
  return (
    <AppLayout>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-5 pb-20">
        ...
        <div className="bg-card border border-border rounded shadow-sm p-5 space-y-4">
          <h2 className="text-sm font-semibold text-foreground">Incident Basics</h2>
        ...
        <div className="bg-card border border-border rounded shadow-sm p-5 space-y-4">
          <h2 className="text-sm font-semibold text-foreground">Situation Details</h2>
          ...
          <details className="group">
            <summary className="cursor-pointer text-sm text-muted-foreground hover:text-foreground transition-colors select-none">
              <span className="ml-1">More details (optional)</span>
            </summary>
        ...
        {can_assign && data.property_id && currentUsers.length > 0 && (
          <div className="bg-card border border-border rounded shadow-sm p-5 space-y-3">
            <fieldset className="space-y-3">
              <h2 className="text-sm font-semibold text-foreground">Team Assignment</h2>
        ...
        {can_manage_contacts && (
          <div className="bg-card border border-border rounded shadow-sm p-5 space-y-3">
            <fieldset className="space-y-3">
              ...
              <Button type="button" variant="outline" size="sm" className="text-sm sm:text-xs" onClick={addContactRow}>
